...
// embed the standard provider in the extern module, because std.fx is a tiny service
export default (): Promise<Service["std.fx"]> => Promise.resolve(provider)

// ----------------------------------------------------------------------------------------------------------------- //
const provider: Service["std.fx"] = {
